...
- [ ] 改造 `docs/prd/PRD_20260604_02_策略1月度滚动重训.md`：实现前必须从 BQML / SQL runner 口径改为 Cloud Run Python / backend-neutral prediction stream；Ledger v1 P0/P1/P2 已完成，后续可以单独评估模型生命周期变化，不再和交易执行语义变化混在一起
