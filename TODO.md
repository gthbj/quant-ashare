...
- [ ] OQ-010：实现回测复合年化收益字段
  说明：`docs/prd/PRD_20260610_01_策略1回测复合年化收益.md` 已定义新增 `compound_annual_return`、保留旧 `annual_return` 为 legacy、report / v3 gate 默认读复合口径；后续需单独代码 PR 实现 summary schema、report、acceptance 和 QA。
