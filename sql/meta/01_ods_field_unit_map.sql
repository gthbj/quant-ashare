...
VALUES
  ...
  -- 金额指标
  ('tushare', 'fina_indicator', 'ods_tushare_fina_indicator', 'netdebt', 'amount', '元', '元', 1, 'dwd_fin_indicator', 'net_debt', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro fina_indicator 接口文档', DATE '2026-06-02', 'GPT-5', '净债务'),
  ('tushare', 'fina_indicator', 'ods_tushare_fina_indicator', 'working_capital', 'amount', '元', '元', 1, 'dwd_fin_indicator', 'working_capital', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro fina_indicator 接口文档', DATE '2026-06-02', 'GPT-5', '营运资本'),
  -- 比率指标（百分比）
...
VALUES
  -- income: 利润表金额字段（元）
  ('tushare', 'income', 'ods_tushare_income', 'total_revenue', 'amount', '元', '元', 1, 'dwd_fin_income', 'total_revenue', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro income 接口文档', DATE '2026-06-02', 'GPT-5', '营业总收入'),
  ('tushare', 'income', 'ods_tushare_income', 'revenue', 'amount', '元', '元', 1, 'dwd_fin_income', 'revenue', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro income 接口文档', DATE '2026-06-02', 'GPT-5', '营业收入'),
  ('tushare', 'income', 'ods_tushare_income', 'total_cogs', 'amount', '元', '元', 1, 'dwd_fin_income', 'total_cogs', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro income 接口文档', DATE '2026-06-02', 'GPT-5', '营业总成本'),
  ('tushare', 'income', 'ods_tushare_income', 'operate_profit', 'amount', '元', '元', 1, 'dwd_fin_income', 'operate_profit', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro income 接口文档', DATE '2026-06-02', 'GPT-5', '营业利润'),
  ('tushare', 'income', 'ods_tushare_income', 'total_profit', 'amount', '元', '元', 1, 'dwd_fin_income', 'total_profit', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro income 接口文档', DATE '2026-06-02', 'GPT-5', '利润总额'),
  ('tushare', 'income', 'ods_tushare_income', 'income_tax', 'amount', '元', '元', 1, 'dwd_fin_income', 'income_tax', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro income 接口文档', DATE '2026-06-02', 'GPT-5', '所得税费用'),
  ('tushare', 'income', 'ods_tushare_income', 'n_income', 'amount', '元', '元', 1, 'dwd_fin_income', 'n_income', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro income 接口文档', DATE '2026-06-02', 'GPT-5', '净利润'),
  ('tushare', 'income', 'ods_tushare_income', 'n_income_attr_p', 'amount', '元', '元', 1, 'dwd_fin_income', 'n_income_attr_p', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro income 接口文档', DATE '2026-06-02', 'GPT-5', '归母净利润'),
  ('tushare', 'income', 'ods_tushare_income', 'ebit', 'amount', '元', '元', 1, 'dwd_fin_income', 'ebit', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro income 接口文档', DATE '2026-06-02', 'GPT-5', '息税前利润'),
  ('tushare', 'income', 'ods_tushare_income', 'ebitda', 'amount', '元', '元', 1, 'dwd_fin_income', 'ebitda', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro income 接口文档', DATE '2026-06-02', 'GPT-5', '息税折旧摊销前利润'),
  -- balancesheet: 资产负债表金额字段（元）
  ('tushare', 'balancesheet', 'ods_tushare_balancesheet', 'total_assets', 'amount', '元', '元', 1, 'dwd_fin_balancesheet', 'total_assets', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro balancesheet 接口文档', DATE '2026-06-02', 'GPT-5', '资产总计'),
  ('tushare', 'balancesheet', 'ods_tushare_balancesheet', 'total_liab', 'amount', '元', '元', 1, 'dwd_fin_balancesheet', 'total_liab', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro balancesheet 接口文档', DATE '2026-06-02', 'GPT-5', '负债合计'),
  ('tushare', 'balancesheet', 'ods_tushare_balancesheet', 'total_hldr_eqy_exc_min_int', 'amount', '元', '元', 1, 'dwd_fin_balancesheet', 'total_hldr_eqy_exc_min_int', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro balancesheet 接口文档', DATE '2026-06-02', 'GPT-5', '股东权益合计(不含少数股东权益)'),
  ('tushare', 'balancesheet', 'ods_tushare_balancesheet', 'money_cap', 'amount', '元', '元', 1, 'dwd_fin_balancesheet', 'money_cap', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro balancesheet 接口文档', DATE '2026-06-02', 'GPT-5', '货币资金'),
  ('tushare', 'balancesheet', 'ods_tushare_balancesheet', 'inventories', 'amount', '元', '元', 1, 'dwd_fin_balancesheet', 'inventories', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro balancesheet 接口文档', DATE '2026-06-02', 'GPT-5', '存货'),
  ('tushare', 'balancesheet', 'ods_tushare_balancesheet', 'accounts_receiv', 'amount', '元', '元', 1, 'dwd_fin_balancesheet', 'accounts_receiv', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro balancesheet 接口文档', DATE '2026-06-02', 'GPT-5', '应收账款'),
  ('tushare', 'balancesheet', 'ods_tushare_balancesheet', 'goodwill', 'amount', '元', '元', 1, 'dwd_fin_balancesheet', 'goodwill', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro balancesheet 接口文档', DATE '2026-06-02', 'GPT-5', '商誉'),
  -- cashflow: 现金流量表金额字段（元）
  ('tushare', 'cashflow', 'ods_tushare_cashflow', 'n_cashflow_act', 'amount', '元', '元', 1, 'dwd_fin_cashflow', 'n_cashflow_act', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro cashflow 接口文档', DATE '2026-06-02', 'GPT-5', '经营活动产生的现金流量净额'),
  ('tushare', 'cashflow', 'ods_tushare_cashflow', 'n_cashflow_inv_act', 'amount', '元', '元', 1, 'dwd_fin_cashflow', 'n_cashflow_inv_act', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro cashflow 接口文档', DATE '2026-06-02', 'GPT-5', '投资活动产生的现金流量净额'),
  ('tushare', 'cashflow', 'ods_tushare_cashflow', 'n_cash_flows_fnc_act', 'amount', '元', '元', 1, 'dwd_fin_cashflow', 'n_cash_flows_fnc_act', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro cashflow 接口文档', DATE '2026-06-02', 'GPT-5', '筹资活动产生的现金流量净额'),
  ('tushare', 'cashflow', 'ods_tushare_cashflow', 'free_cashflow', 'amount', '元', '元', 1, 'dwd_fin_cashflow', 'free_cashflow', FALSE, NULL, 'verified', NULL, NULL, 'Tushare Pro cashflow 接口文档', DATE '2026-06-02', 'GPT-5', '企业自由现金流量');
