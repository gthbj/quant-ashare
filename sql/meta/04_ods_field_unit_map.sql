...
INSERT INTO `data-aquarium.ashare_meta.ods_field_unit_map`
VALUES
  ('tushare', 'dividend', 'ods_tushare_dividend', 'cash_div_tax', 'per_share', '元/股', '元/股', 1, 'dwd_stock_dividend_event', 'cash_div_per_share_pretax', FALSE, NULL, 'verified', NULL, NULL, 'PRD_20260612_01 Phase A contract；BQ 只读样例 600188.SH@20230717 / 601966.SH@20250710 已验证字段可读与同日聚合', DATE '2026-06-12', 'GPT-5.5', 'ledger 消费每股税前现金分红，按 sec_code/ex_date SUM'),
