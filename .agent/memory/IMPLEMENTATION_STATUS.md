...
- 结果解释 caveat 不变：本轮结果是当前 DWS 覆盖下的 effective-window refit，2021-2024 不代表名义完整五年 refit。OQ-014 仍需 owner 决定是否接受该口径进入 baseline 评估，或先修复 / 重建历史 DWS lookback 与 valuation 覆盖后追求 true pre-2019 五年窗口。
