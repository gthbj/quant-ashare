...
当前阶段：**P0 数仓底座、财务口径、单位契约、OQ-004 benchmark 口径、OQ-005 Scheduler/Workflows 生产调度迁移、OQ-006 单位治理、OQ-012 ODS Parquet schema mismatch 收口、OQ-011 true-five-year 覆盖决策均已完成或关闭；Strategy1 已完成 research-first / promotion 架构、package entrypoint cutover、年度 final refit + synthetic continuous ledger 工程闭环。研究 baseline 自 DECISION-20260612-01 起为 true-five-year continuous（`bt_s1_annual_roll_continuous_true5y_2021_2026_n20_w075_v20260611_01`，contract Sharpe `0.6076` / Calmar `0.3725`，未过 v3 双门，baseline ≠ accepted），effective-window 降级为历史参照。仍开放的主线只剩 OQ-010 策略 accepted baseline / 风险调整收益迭代。**
