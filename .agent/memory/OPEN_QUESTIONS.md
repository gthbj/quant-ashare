...
| ID | 问题 | 状态 | Owner | 相关文件 |
|---|---|---|---|---|
| OQ-003 | 财务 `report_type` 口径：默认取合并报表 `'1'`；是否需要母公司/单季调整等口径维度？PRD 已提出 P0 默认合并报表、DWD 保留口径字段、DWS 默认过滤的推荐方案。 | open: PRD 待 owner review | owner | docs §6.5, §10; `docs/prd/PRD_20260601_03_财务报表口径维度.md` |
