...
| OQ-006 | 金额单位逐接口换算系数表尚未逐一核对（仅核对了 daily 等核心表）；建议收敛为单位契约 + 覆盖检查 + DWD 准入门禁。 | open: PRD 草案已写并按 review feedback 修订，待 owner review 与后续实现 | owner | docs §3.3-G, §10; `docs/prd/PRD_20260602_01_OQ006接口单位换算口径.md` |
