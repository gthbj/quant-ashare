...
- **下一步**：按实现 PRD 落地策略 1 BigQuery ML + SQL 训练/预测/组合/回测 runner（写入 ADS 并输出 RankIC/分层收益/NAV/换手/不可成交比例）；或补 P0 通用财务/市场状态 DWS（`dws_stock_feature_fin_daily`、`dws_market_state_daily`）和财务三表。
