...
3. 运行前必须先完成 `2019-01-02..2019-04-02` 旗标修复、2010+ 历史 backfill、`sql/qa/13_true5y_historical_coverage_checks.sql` 与逐年 refit panel coverage QA。overlap parity 工具已按 `DECISION-20260612-01` 退役；历史验收记录见 `.agent/memory/IMPLEMENTATION_STATUS.md` 的 2026-06-11 true-five-year 小节。
